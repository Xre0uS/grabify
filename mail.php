...
function activateAccountMail($email, $username, $token)
{
  ...
  $content .= '<p>-------------------------------------------------------------</p>';
  $content .= '<p><a href="http://localhost/grabify/activateaccount.php?key=' . $token . '&action=activate" target="_blank">
  http://localhost/grabify/activateaccount.php?key=' . $token . '&action=activate</a></p>';
  $content .= '<p>-------------------------------------------------------------</p>';
  $content .= '<p>Please be sure to copy the entire link into your browser.
