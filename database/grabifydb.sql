...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2020 at 10:11 AM
...
--
-- Database: `swap-schema`
--
CREATE DATABASE IF NOT EXISTS `swap-schema` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `swap-schema`;
