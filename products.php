...
if(isset($_SESSION["username"]))
{
    ...
    echo "<tr><td>Name</td><td>Price</td><td>Description</td><td>Location</td><td>Business Name</td><td></td>";
        while ($stmt->fetch()){
            ...
            <input class='viewproduct' type='submit' value='".$name."'></form>
            
            
            
            
            </td><td>$" .$price. "</td><td>" .$description. "</td><td>" .$location. "</td><td>".$busName."</td><td>
            
            <form action='favourites.php' method='post'>
            <input type='hidden' value='".$productID."' name='prodID'>
            <input type='hidden' value='".$userID."' name='userID'> 
            <select id='cat' name='cat'><option value='MUST-BUY'>MUST-BUY</option><option value='OPTIONAL'>OPTIONAL</option></select> 
            <input type='submit' value='Add to Favourite'></form>
